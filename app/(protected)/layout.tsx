...
function SidebarIcon({ type, className = "w-4 h-4" }: { type?: string; className?: string }) {
  ...
  switch (type) {
    ...
    case "stocktake": return <svg {...s} className={className} viewBox="0 0 24 24"><path d="m9 11 3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>;
    ...
    case "sales": return <svg {...s} className={className} viewBox="0 0 24 24"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>;
    default: return null;
  }
}
