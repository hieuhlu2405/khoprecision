      ...
      >
        <div className="flex flex-wrap gap-4 items-end">
          ...
          <div className="w-56 relative group">
            ...
            <input list="dl-cust" placeholder="Nhập tên khách hàng..." value={qCustomerSearch} onChange={e => { setQCustomerSearch(e.target.value); const m = customers.find(c => `${c.code} - ${c.name}` === e.target.value); setQCustomer(m ? m.id : ""); }} className="input border-slate-200/60 transition-all rounded-lg h-10 w-full focus:bg-white" />
          ...
          <div className="w-56 relative group">
            ...
            <input value={qProduct} onChange={e => setQProduct(e.target.value)} placeholder="Nhập mã hàng..." className="input border-slate-200/60 transition-all rounded-lg h-10 w-full focus:bg-white" />
          </div>
