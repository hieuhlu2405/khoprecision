        ...
        <table className="data-table">
          <thead>
            <tr className="bg-white/95 backdrop-blur-md">
              ...
              <ThCell label="Đơn giá" colKey="unitCost" sortable colType="num" w="100px" align="right" />
          ...
          <tbody>
            {paginatedFiltered.length === 0 ? (
              <tr><td colSpan={(canEdit || canDelete) ? 13 : 12} className="py-20 text-center opacity-40 italic">Không tìm thấy phiếu xuất nào khớp bộ lọc.</td></tr>
                ...
                <Fragment key={r.id}>
                  ...
                  {isExpanded && hasAdjs && (
                    <tr style={{ background: "var(--slate-50)" }}>
                      <td colSpan={(canEdit || canDelete) ? 13 : 12} style={{ padding: "16px 24px" }}>
             ...
             {finalFiltered.length === 0 && (
               <tr>
                 <td colSpan={(canEdit || canDelete) ? 13 : 12} style={{ padding: 16, textAlign: "center", color: "#999" }}>
                  Không có dữ liệu
                </td>
              </tr>
            )}
